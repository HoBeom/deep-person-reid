...
def get_default_config():
    ...
    # video reid setting
    cfg.video = CN()
    cfg.video.seq_len = 16 # number of images to sample in a tracklet
    cfg.video.sample_method = 'evenly' # 'first' 'all' #'random' #'evenly' # how to sample images from a tracklet
